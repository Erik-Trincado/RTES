...
def resultado3():
    ...
    ang_min_grados_r= round(ang_min_grados,2)
    ang_max_grados_r= round(ang_max_grados,2)
    trend_3_r = round(trend_3,2)
    
    resu1= cuadrante(ang_min_grados_r)
    resu2= cuadrante(ang_max_grados_r)
    resu3= cuadrante(trend_3_r) 
